...
min_hight_react=80      #Min hight rectangle

count_line_position=550
# Initializing the sunstractor
...
while True:
    ...
    cv2.line(frame1,(25,count_line_position),(1366,count_line_position),(255,127,0),3)
    ...
    for (i,c) in enumerate(countershape):
        ...
        for (x,y) in detect:
            if x<(count_line_position + offset) and y<(count_line_position + offset):
                counter+=1
            cv2.line(frame1,(25,count_line_position),(1366,count_line_position),(0,127,255),3)
            detect.remove((x,y))
            print("Vehical Counter:"+str(counter))

    cv2.putText(frame1,"VEHICLE COUNTER:"+str(counter),(450,70),cv2.FONT_HERSHEY_SIMPLEX,2,(0,0,255),5)        

    #cv2.imshow("Detector",dilatata)
